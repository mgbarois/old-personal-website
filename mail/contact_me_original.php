	...
	<div class="container">
		<div class="message">
			...
			if(empty($_POST['name']))  		
			{
				...
				if ($lang == 'en')
				{
					echo "<p>Please give your name.</p><a href=\"en.php\"><button type=\"submit\" class=\"btn btn-default\">Back to the page</button></a>";
				}
				else 
				{
					echo "<p>N'oublier de renseigner votre nom.</p><a href=\"fr.php\"><button type=\"submit\" class=\"btn btn-default\">Retour à la page</button></a>";
				}
				return false;
			...
			if (empty($_POST['email'])) 
			{
				if ($lang == 'en')
				{
					echo "<p>Please give your e-mail.</p><a href=\"en.php\"><button type=\"submit\" class=\"btn btn-default\">Back to the page</button></a>";
				}
				else 
				{
					echo "<p>N'oublier pas de renseigner votre adress mail.</p><a href=\"fr.php\"><button type=\"submit\" class=\"btn btn-default\">Retour à la page</button></a>";
				}
				return false;
			}
			...
			if (empty($_POST['message']))
			{
				if ($lang == 'en')
				{
					echo "<p>Please include a message.</p><a href=\"en.php\"><button type=\"submit\" class=\"btn btn-default\">Back to the page</button></a>";
				}
				else 
				{
					echo "<p>N'oublier pas d'écrire un message.</p><a href=\"fr.php\"><button type=\"submit\" class=\"btn btn-default\">Retour à la page</button></a>";
				}
				return false;
			}
